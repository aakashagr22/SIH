...
// Create an array for article numbers from 1 to 40
...
// Create the chart for the wheel
    ...
    datasets: [
      {
        ...
        data: Array(articleNumbers.length).fill(1), // Equal probability for each number
      },
    ],
  },
  options: {
    ...
    plugins: {
      ...
      datalabels: {
        ...
        font: { size: 10 }, // Adjust font size for the smaller wheel
      },
    },
  },
});

// Function to determine the result based on the random angle
